...
# ISTN One Portal SC-DATA API DuckDB — POWERFUL V2

Versi ini adalah paket lengkap web akademik ISTN One Portal yang sudah ditingkatkan menjadi **fullstack lokal**:
