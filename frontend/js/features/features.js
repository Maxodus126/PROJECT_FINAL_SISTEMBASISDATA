/**
 * ISTN ONE PORTAL — FEATURES EXTENSION
 * =====================================================
...
(function () {
  ...
  const seedInternships = [
    { id: 'PKL001', company: 'PT Telkom Indonesia', position: 'Junior Data Analyst', student: '24360007', studentName: 'Aflin Awaludin', supervisor: 'D001', startDate: '2026-07-01', endDate: '2026-09-30', status: 'Menunggu Persetujuan', score: null, report: null },
    { id: 'PKL002', company: 'Google Indonesia', position: 'Software Engineering Intern', student: '24360006', studentName: 'Nabila Latifatul Hamdah', supervisor: 'D003', startDate: '2026-07-15', endDate: '2026-10-15', status: 'Disetujui', score: null, report: 'Laporan PKL Minggu 1-4.pdf' },
    { id: 'PKL003', company: 'Bank BRI (IT Division)', position: 'Backend Developer Intern', student: '24360002', studentName: 'Putri Nurhaliza', supervisor: 'D004', startDate: '2026-06-01', endDate: '2026-08-31', status: 'Berjalan', score: null, report: 'Laporan PKL Minggu 1-8.pdf' },
  ];

  const seedTheses = [
    { id: 'TA001', nim: '24360007', title: 'Implementasi RAG (Retrieval-Augmented Generation) untuk Sistem Informasi Akademik Kampus Berbasis DuckDB', supervisor1: 'Oni Bibin Bintoro, Ing., Dipl.-Sci., MBA, MBI.', supervisor2: 'MARHAENI, S.Kom., M.Kom.', status: 'Pengajuan Judul', stage: 1, submitted: '2026-06-20', defense: null, score: null },
  ...
  const seedForumThreads = [
    { id: 'FRM001', courseId: 'sbdm', title: 'Pertanyaan tentang DuckDB vs PostgreSQL', body: 'Pak dosen, saya ingin bertanya — kapan sebaiknya kita memilih DuckDB dibandingkan PostgreSQL dalam konteks analitik data?', author: 'Aflin Awaludin', authorRole: 'Mahasiswa', date: '2026-06-28 10:15', replies: 3, likes: 7 },
    { id: 'FRM002', courseId: 'algo', title: 'Implementasi Dynamic Programming untuk soal UTS', body: 'Untuk soal UTS kemarin nomor 4, apakah boleh menggunakan DP bottom-up? Saya bingung memilih antara top-down dan bottom-up.', author: 'Muhammad Sechan Auriel', authorRole: 'Mahasiswa', date: '2026-06-27 14:30', replies: 5, likes: 12 },
    { id: 'FRM003', courseId: 'cloud', title: 'Error saat deploy container di AWS', body: 'Saya mendapatkan error "Container exited with code 1" saat mencoba deploy di AWS ECS. Sudah coba beberapa konfigurasi tapi masih gagal.', author: 'Fadil Ardiansyah', authorRole: 'Mahasiswa', date: '2026-06-26 09:45', replies: 2, likes: 4 },
    { id: 'FRM004', courseId: 'sbdm', title: 'Diskusi: Pentingnya Vector Database dalam arsitektur RAG', body: 'Setelah mempelajari materi modul 12, saya merasa vector database seperti Chroma atau Weaviate sangat krusial. Bagaimana pendapat teman-teman?', author: 'Nabila Latifatul Hamdah', authorRole: 'Mahasiswa', date: '2026-06-25 16:00', replies: 8, likes: 15 },
  ];

  const seedHelpdesk = [
    { id: 'TKT001', subject: 'Nilai UTS tidak muncul di portal', category: 'Akademik', priority: 'Tinggi', status: 'Selesai', submitter: 'Aflin Awaludin', role: 'Mahasiswa', date: '2026-06-20', resolvedDate: '2026-06-22', response: 'Nilai sudah diinput oleh dosen. Silakan cek kembali di menu Nilai & KHS.' },
    { id: 'TKT002', subject: 'Tidak bisa login ke portal setelah reset password', category: 'Teknis', priority: 'Tinggi', status: 'Proses', submitter: 'Dosma Silitonga', role: 'Mahasiswa', date: '2026-06-25', resolvedDate: null, response: 'Tim teknis sedang menyelidiki. Estimasi selesai 2x24 jam.' },
    { id: 'TKT003', subject: 'Permintaan surat keterangan aktif untuk beasiswa', category: 'Administrasi', priority: 'Sedang', status: 'Menunggu', submitter: 'Putri Nurhaliza', role: 'Mahasiswa', date: '2026-06-27', resolvedDate: null, response: null },
    { id: 'TKT004', subject: 'Error saat mengupload dokumen laporan PKL', category: 'Teknis', priority: 'Sedang', status: 'Selesai', submitter: 'Raffli Islami Fashya', role: 'Mahasiswa', date: '2026-06-18', resolvedDate: '2026-06-19', response: 'Ukuran file melebihi batas 10MB. Kompres file dan upload ulang.' },
  ];

  const seedOrganizations = [
    { id: 'ORG001', name: 'Himpunan Mahasiswa Teknik Informatika (HMTI)', type: 'Himpunan', description: 'Organisasi resmi mahasiswa Prodi Teknik Informatika ISTN', members: 45, events: 12, advisor: 'Dikky Suryadi, S.Kom., M.Kom.', status: 'Aktif' },
    { id: 'ORG002', name: 'UKM Robotik & AI ISTN', type: 'UKM', description: 'Unit kegiatan mahasiswa bidang robotika, AI, dan otomasi industri', members: 28, events: 8, advisor: 'MARHAENI, S.Kom., M.Kom.', status: 'Aktif' },
    { id: 'ORG003', name: 'UKM Pramuka ISTN', type: 'UKM', description: 'Gerakan Pramuka Gugus Depan ISTN untuk pembentukan karakter', members: 60, events: 15, advisor: 'B. SUMARDIYONO, ST., M.Kom.', status: 'Aktif' },
    { id: 'ORG004', name: 'Koperasi Mahasiswa (KopMa) ISTN', type: 'Koperasi', description: 'Koperasi simpan pinjam dan usaha mahasiswa ISTN', members: 120, events: 5, advisor: 'Ir. ANDI SUPRIANTO, M.Kom.', status: 'Aktif' },
    { id: 'ORG005', name: 'UKM Olahraga & Seni', type: 'UKM', description: 'Basket, futsal, bulu tangkis, dan seni tari tradisional', members: 80, events: 20, advisor: 'Moch. Zhuhriansyah Rahman, ST., MT.', status: 'Aktif' },
  ];
          ...
          <div class="activity-list">
            ${state.notifications.map(n => `
              <div class="activity-item" style="opacity:${n.read ? 0.65 : 1}">
                <span class="activity-icon" style="font-size:16px">${typeIcon(n.type)}</span>
                <div class="item-body">
  ...
  function newMetricCard(icon, label, value, trend) {
    return `<article class="card metric-card"><div class="metric-icon" style="font-size:20px">${icon}</div><div><div class="metric-value">${esc(String(value))}</div><div class="metric-label">${esc(label)}</div><div class="metric-trend">${esc(trend)}</div></div></article>`;
  }
